...
import gc
from PyQt5.QtWidgets import QMainWindow, QApplication, QFileDialog, QHBoxLayout, QFrame, QSizePolicy
...
class AppLogic:
    def __init__(self, ui, vtk_widget):
        self.ui = ui
        self.volume_renderer = VolumeRenderer(vtk_widget)
    ...
    def setup_ui_connections(self):
        ...
        self.ui.cyl_cube.clicked.connect(self.clear_window)


    def removeplaceholder_addCube(self):        
        self.volume_renderer.clear_all_actors()
        print("sleeping for 4 seconds...Loading cube...")
...
class DemoApp(QMainWindow):
    ...
    def setup(self):
        ...
        # Create a layout for vtk_panel
        self.ui.vtk_panel_layout = QHBoxLayout()
        self.ui.vtk_panel_layout.addWidget(self.vtk_widget)
        self.ui.vtk_panel_layout.setContentsMargins(0, 0, 0, 0)
        # Set the layout for vtk_panel
        self.ui.vtk_panel.setLayout(self.ui.vtk_panel_layout)
        self.logic = AppLogic(self.ui, self.vtk_widget)
